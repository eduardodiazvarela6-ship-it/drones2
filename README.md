...
Dashboard estático inspirado en WAQI para monitoreo de calidad de aire centrado en Lima y Callao, con referencias nacionales en 25 departamentos. Incluye mapa Leaflet, filtros por riesgo/territorio, KPIs, rankings, alertas, noticias, reloj local, guía rápida de salud y bloque de fábricas aliadas con emisiones controladas.
...
- `web/data/air_quality.json`: 25+ estaciones priorizadas en Lima/Callao y cobertura nacional.
- `web/data/*.json`: departamentos, alertas, noticias, tendencias horarias, rankings, guía de salud y fábricas aliadas.
